...
console.log(isFinite('10'));            // true >숫자 변환가능하니까
console.log(isFinite(null));            // true >null은 숫자로 0이고 0은 유한한 숫자니까

console.log(isFinite(Infinity));        // false
console.log(isFinite(-Infinity));       // false

console.log(isFinite(NaN));             // false
console.log(isFinite('abc'));           // false >숫자로 못바뀌니까
console.log('-------------------------------');

// isNaN
// 전달 받은 인수가 "NaN인지 검사"하여 그 검사 결과를 불리언 타입으로 반환
// 전달 받은 인수가 "숫자가 아닌 경우! 숫자로 타입 변환 후 검사"를 수행
console.log(isNaN(NaN));                // true
console.log(isNaN(10));                 // false

console.log(isNaN('abc'));              // true 숫자로 변환하면 nan이니까
console.log(isNaN('10'));               // false
console.log(isNaN(''));                 // false >(''은 => 0으로 판단되니까)

console.log(isNaN(true));               // false (true => 1)
console.log(isNaN(false));              // false (false => 0)

console.log(isNaN(undefined));          // true >숫자로 변환불가라

console.log(isNaN({}));                 // true >숫자로 변환불가라
console.log('-------------------------------');
...
console.log(parseFloat('10 20 30'));    // 10 >공백만나면 그 뒤로 다 버림
// 숫자가 아닌 문자열은 제외하고 변환
console.log(parseFloat('10cm'));        // 10 >다른문자 만나면 다 버림
// 첫 번째 문자열을 숫자로 변환할 수 없다면 변환 불가
console.log(parseFloat('GS25'));        // NaN >첫번째가 숫자로 변환 안되면nan
// 앞뒤 공백은 무시
console.log(parseFloat('  1004  '));    // 1004

// parseInt : 전달받은 문자열 인수를 "정수"로 해석하여 반환
console.log(parseInt('10'));            // 10
console.log(parseInt('10.01'));         // 10
console.log('-------------------------------');

// encodeURI : 도 전역객체에 선언된 함수다.
