...
console.log(Math.round(10.1));                  // 10 반올림함            
...
console.log(Math.ceil(10.1));                   // 11  올림           
...
console.log(Math.floor(10.1));                  // 10  내림          
...
console.log(Math.sqrt(-4));                     // NaN 연산안돼서 nan
...
console.log(Math.random());    //0.49411691837271476           
// 1~100 범위의 난수 추출       
const random = Math.floor((Math.random() * 100) + 1);
console.log(random);            //96
console.log('--------------------');
...
console.log(Math.min());                        // Infinity >양의무한대
console.log('--------------------');      
