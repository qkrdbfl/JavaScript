...
console.log(Number.isInteger(10));          // true 정수
console.log(Number.isInteger(-10));         // true 정수
...
console.log((1.23456).toFixed(1)); //소수점 몇자리까지 반올림 할거냐 // 1.2
console.log('----------------------');
...
console.log((123.456).toPrecision(5));//총자리수 5개에 반올림한다  // 123.46
...
console.log((100).toString());                  // 100  몇진법으로 계산할거냐
